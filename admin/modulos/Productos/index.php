        ...
        <div id="nuevo_producto_modulo">
            <form id="nuevoproductoform">
                ...
                <div class="relative mb-6" data-te-input-wrapper-init>
                    ...
                    <label for="idproducto" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[te-input-state-active]:-translate-y-[0.9rem] peer-data-[te-input-state-active]:scale-[0.8] motion-reduce:transition-none  ">ID Del Grupo
                    </label>
                ...
                <div class="relative mb-6" data-te-input-wrapper-init>
                    <input maxlength="11" data-te-input-showcounter="true" max name="id_grupo" type="text" class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none  [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="id_grupo" value="<?php
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                $consulta = ' SELECT MAX(CAST(SUBSTRING(id_grupo, 1) + 1 AS UNSIGNED)) AS ultimo_id_grupo FROM productos_agrupados;
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ';
