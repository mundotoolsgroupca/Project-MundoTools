            ...
            <form id="nuevoproductoform">
                ...
                <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                    ...
                    <div class="relative mb-6 hidden peer-checked/caracteristica2:block" data-te-input-wrapper-init>
                        <textarea value='...' maxlength="40" data-te-input-showcounter="true"  class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" name='' id="caracteristica2" rows="3" placeholder="Descripcion" required></textarea>
                ...
                <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                    ...
                    <div class="relative mb-6 hidden peer-checked/caracteristica5:block" data-te-input-wrapper-init>
                        <textarea value='...' maxlength="40" data-te-input-showcounter="true"  class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0" id="Caracteristica5" rows="3" placeholder="Descripcion" required></textarea>
