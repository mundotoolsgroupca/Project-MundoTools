...
function validar_SimboloMoneda($simbolo)
{
    ...
    return in_array($simbolo, $simbolosPermitidos);
}
...
function RespaldarBase($strUsuario, $strPassword, $strHost, $strBaseDeDatos, $strNombreRespaldo)
{
    $archivo_respaldo = $strNombreRespaldo . ".sql";
    $comando = "mysqldump -u $strUsuario -p$strPassword -h $strHost $strBaseDeDatos --routines --triggers > $archivo_respaldo";
    exec($comando);
}
