            ...
            <div class="[ mx-auto p-3  ] [ lg:flex lg:h-full lg:justify-center    lg:w-4/5 lg:gap-3  ]">
                ...
                <div class="[ lg:w-[300px] lg:h-full lg:p-3 lg:rounded-lg hidden ] [ md:hidden ] [ lg:block ]">
                    ...
                    if (isset($_GET['query'])) {
                        ...
                        $categoria = "<p class='text-[#FBAA35] font-bold transition duration-150 ease-in-out hover:text-[#FBAA35] focus:text-[#FBAA35] active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-[#FBAA35]'>" . $row['nombre'] . " ('" . $row['total_count'] . "')</p>";
                    }
