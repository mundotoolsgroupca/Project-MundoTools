                ...
                <div class="w-64 px-4">
                    <div class="px-2 pt-4 pb-8  ">
                        <ul class="space-y-2">
                            ...
                            <li>
                                <a href="../tienda" data-te-ripple-init data-te-ripple-color="light" class="hover:bg-gray-500 hover:bg-opacity-10 hover:text-blue-600 flex items-center text-gray-700 py-1.5 px-4 rounded space-x-2 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
